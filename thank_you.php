...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Submission Successfull!</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
    <h1>Thank you for submiting your form.</br> You will receive an email shortly...</h1>
    </div>
